...
{
    public class FindWaresOnPageCommandHandler : IRequestHandler<FindWaresOnPageCommand, Page<Ware>>
    {
        ...
        public async Task<Page<Ware>> Handle(FindWaresOnPageCommand request, CancellationToken cancellationToken)
        {
