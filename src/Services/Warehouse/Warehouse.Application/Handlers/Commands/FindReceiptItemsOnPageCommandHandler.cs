...
{
    public class FindReceiptItemsOnPageCommandHandler : IRequestHandler<FindReceiptItemsOnPageCommand, Page<Receipt.Item>>
    {
        ...
        public async Task<Page<Receipt.Item>> Handle(FindReceiptItemsOnPageCommand request, CancellationToken cancellationToken)
        {
