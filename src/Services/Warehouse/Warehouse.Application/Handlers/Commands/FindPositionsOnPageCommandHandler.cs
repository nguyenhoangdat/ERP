...
{
    public class FindPositionsOnPageCommandHandler : IRequestHandler<FindPositionsOnPageCommand, Page<Position>>
    {
        ...
        public async Task<Page<Position>> Handle(FindPositionsOnPageCommand request, CancellationToken cancellationToken)
        {
